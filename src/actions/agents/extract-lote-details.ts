...
export async function extractLoteDetails(loteText: string, globalContext?: any) {
  ...
  const prompt = `
    ...
    19. Private Area (Área privativa - Always use "m²" as unit, e.g., "50,00 m²")
    20. Total Area (Área total - Always use "m²" as unit, e.g., "100,00 m²")
    21. Land Area (Área de terreno - Always use "m²" as unit, e.g., "200,00 m²")
